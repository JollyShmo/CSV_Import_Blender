[![version](https://github.com/JollyShmo/CSV_Import_Blender/blob/main/version_csv_import.png)]([csv_mesh_importer.zip](https://github.com/JollyShmo/CSV_Import_Blender/releases/download/v1.0.0/csv_mesh_importer.zip))
